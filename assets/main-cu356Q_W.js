...
`;let te={html:function(e){return A(be,e)},dom:function(e){return c(te.html(e))}};const we=`<div class="product-gallery grid grid-cols-4 gap-2 mt-4">
  {{gallery}}
...
</div>`;let re={html:function(e){return A(Ie,e)},dom:function(e){return c(re.html(e))}};const $e=`<div class="p-12">
  <a
    href="#"
    id="btnRetour"
...
`;let oe={};oe.dom=function(){return c(De)};const Te=`<div class="profile-page">
    <slot name="profile" id="profile"></slot>
</div>`;let O={};O.handler_clickOnLogout=async function(e){e.preventDefault(),console.log("Déconnexion..."),await C.logout(),window.router&&window.router.setAuth(!1),setTimeout(()=>{window.router?window.router.navigate("/login"):window.location.hash="/login"},100)};O.init=function(){return M.init()};let M={};M.init=function(){let e=M.createPageFragment();return M.attachEvents(e),e};M.createPageFragment=function(){let e=c(Te),t=oe.dom();const n=e.querySelector('slot[name="profile"]');return n&&n.replaceWith(t),e};M.attachEvents=function(e){let t=e.querySelector('button[type="button"]');return t&&t.addEventListener("click",O.handler_clickOnLogout),e};function Fe(){return O.init()}const Ue=`        
...
`;let ze={html(){let e=B.html();return console.log(e),Q.replace('<slot name="categories-nav"></slot>',e)},dom(){let e=c(Q),t=e.querySelector('slot[name="categories-nav"]');t&&t.replaceWith(B.dom());let n=e.querySelector('slot[name="categories-nav-mobile"]');return n&&n.replaceWith(B.dom()),setTimeout(()=>{const a=document.getElementById("burger-menu-btn"),r=document.getElementById("mobile-menu");a&&(a.onclick=()=>{r.classList.toggle("hidden");const s=a.querySelectorAll("span"),o=!r.classList.contains("hidden");s[0].style.transform=o?"rotate(45deg) translate(5px, 7px)":"none",s[1].style.opacity=o?"0":"1",s[2].style.transform=o?"rotate(-45deg) translate(5px, -7px)":"none"})},100),e}};const He=`<footer class="bg-white px-4 md:px-9 py-12 md:py-16 box-border" style="font-family: 'Heebo', sans-serif;">
    ...
    </footer>`;let le={html:function(e){return A(He,e)},dom:function(e){return c(le.html(e))}};function Qe(){let e=c(We),t=ze.dom(),n=le.dom();return e.querySelector('slot[name="header"]').replaceWith(t),e.querySelector('slot[name="footer"]').replaceWith(n),e}const Ge=` <section>
    <h1>404 - Page non trouvée</h1>
        <p>Cette page n'existe pas</p>
    <nav>
        <a href="/" data-link>Retour à l'accueil</a>
    </nav>
</section>`;function Je(){return Ge}const p=new ce("app",{loginPath:"/login",basePath:"/Site-commerce/"});window.router=p;const G=await P.Auth();G&&G.auth?p.setAuth(!0):p.setAuth(!1);p.addLayout("/",Qe);p.addRoute("/",_);p.addRoute("/about",de);p.addRoute("/products",_);p.addRoute("/login",Be,{useLayout:!1});p.addRoute("/data",Me,{useLayout:!1});p.addRoute("/cart",Ve,{requireAuth:!0});p.addRoute("/signup",qe,{useLayout:!1});p.addRoute("/products/categories/:id",_);p.addRoute("/profile",Fe,{requireAuth:!0});p.addRoute("/products/:id/:slug",Ce);p.addRoute("*",Je);p.start();
